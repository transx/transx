 ...
 */
public class UISelectChairItem extends UIComponentBase {
	...
	// Property: itemFemale
	private boolean _itemFemale;
	
	/**
	 * Gets Determine whether this item can be for a Female !
	 * 
	 * @return the new itemFemale value
	 */
	public boolean isItemFemale() {
		ValueExpression expression = getValueExpression("itemFemale");
		if (expression != null) {
			return (Boolean) expression.getValue(getFacesContext()
					.getELContext());
		}
	...
	/**
	 * Sets Determine whether this item can be for a Female
	 * 
	 * @param itemDisabled the new itemFemale value
	 */
	public void setItemFemale(boolean itemFemale) {
		this._itemFemale = itemFemale;
	}
